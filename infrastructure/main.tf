locals {
  ...
  aat_rules_url = "https://snl-rules-aat.service.core-compute-aat.internal"
  local_rules_url = "https://snl-rules-${var.env}.service.${data.terraform_remote_state.core_apps_compute.ase_name[0]}.internal"
