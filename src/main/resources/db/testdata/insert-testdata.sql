...
-- hearings
INSERT INTO hearing_part (id, case_number, case_title, case_type, hearing_type_code, duration, schedule_start, schedule_end, session_id, start, created_at, created_by)
VALUES ('b262fc78-dc98-484b-849b-7b96d7753918','1234','case title 1','FTRACK','preliminary-hearing',3600,'2018-05-02','2018-06-02',NULL,NULL, '2018-03-01 7:11:11', 'joe_script');

INSERT INTO hearing_part (id, case_number, case_title, case_type, hearing_type_code, duration, schedule_start, schedule_end, session_id, start, created_at, created_by)
VALUES ('13d4e4da-e817-4e7d-8e29-ed467c5d5d2f','abcde','case title 2','SCLAIMS','trial',3600,'2018-05-02','2018-06-02',NULL,NULL, '2018-03-01 7:11:11', 'joe_script');

INSERT INTO hearing_part (id, case_number, case_title, case_type, hearing_type_code, duration, schedule_start, schedule_end, session_id, start, created_at, created_by)
VALUES ('dd77dbe1-7527-4dc7-b18a-6898a4a92b7d','9999','case title 3','MTRACK','trial',1800,'2018-05-02','2018-06-02',NULL,NULL, '2018-03-01 7:11:11', 'joe_script');

INSERT INTO hearing_part (id, case_number, case_title, case_type, hearing_type_code, duration, schedule_start, schedule_end, session_id, start, created_at, created_by)
VALUES ('cf3a7605-5d27-45ef-a1a3-6424fe0a7376','7777','case title 4','FTRACK','adjourned-hearing',900,'2018-03-02','2018-06-02',
